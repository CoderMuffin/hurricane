...
float hc_vec2_sqrmag(hc_vec2 v) { return v.v[0] * v.v[0] + v.v[1] * v.v[1]; }
float hc_vec3_sqrmag(hc_vec3 v) { return v.v[0] * v.v[0] + v.v[1] * v.v[1] + v.v[2] * v.v[2]; }

float hc_vec2_mag(hc_vec2 v) { return sqrt(v.v[0] * v.v[0] + v.v[1] * v.v[1]); }
