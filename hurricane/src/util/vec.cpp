...
const fixed hc_vec3_zero[3] = {0, 0, 0};
const fixed hc_vec3_one[3] = {1, 1, 1};

const fixed hc_vec3_forward[3] = {0, 0, 1};
const fixed hc_vec3_backward[3] = {0, 0, -1};
const fixed hc_vec3_left[3] = {-1, 0, 0};
const fixed hc_vec3_right[3] = {1, 0, 0};
const fixed hc_vec3_up[3] = {0, 1, 0};
const fixed hc_vec3_down[3] = {0, -1, 0};
